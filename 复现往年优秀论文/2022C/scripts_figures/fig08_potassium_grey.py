"""图08 高钾SiO2灰色关联。来源：PDF p25-28。按正文公式重算；并非原SPSSPRO曲线逐值复刻。"""
import sys
...
def draw(data, args):
    ...
    ax.set_ylim(0, 1.04)
    ax.set_title('高钾玻璃：以SiO2为母序列的灰色关联系数')
    ...
    finish(fig, args, 'fig08_potassium_grey')
