"""补充 铅钡SnO2灰色关联。来源：PDF p25-28。正文声称遍历但PDF未附该母序列图；补齐计算图。"""
import sys
...
def draw(data, args):
    ...
    ax.set_ylim(0, 1.04)
    ax.set_title('铅钡玻璃：以SnO2为母序列的灰色关联系数')
    ...
    finish(fig, args, 'supplement_grey_lead_barium_SnO2')
