"""补充 高钾SO2灰色关联。来源：PDF p25-28。正文声称遍历但PDF未附该母序列图；补齐计算图。"""
import sys
...
def draw(data, args):
    ...
    ax.set_ylim(0, 1.04)
    ax.set_title('高钾玻璃：以SO2为母序列的灰色关联系数')
    ...
    finish(fig, args, 'supplement_grey_potassium_SO2')
